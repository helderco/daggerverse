...
// The `CodegenEnumValueID` scalar type represents an identifier for an object of type CodegenEnumValue.
type CodegenEnumValueID string

// The `CodegenExperimentalID` scalar type represents an identifier for an object of type CodegenExperimental.
type CodegenExperimentalID string

// The `CodegenFieldID` scalar type represents an identifier for an object of type CodegenField.
type CodegenFieldID string

// The `CodegenID` scalar type represents an identifier for an object of type Codegen.
type CodegenID string

// The `CodegenInputValueID` scalar type represents an identifier for an object of type CodegenInputValue.
type CodegenInputValueID string

// The `CodegenSchemaID` scalar type represents an identifier for an object of type CodegenSchema.
type CodegenSchemaID string

// The `CodegenTypeID` scalar type represents an identifier for an object of type CodegenType.
type CodegenTypeID string

// The `CodegenTypeRefID` scalar type represents an identifier for an object of type CodegenTypeRef.
type CodegenTypeRefID string
...
func (r *Codegen) Experimental() *CodegenExperimental {
	q := r.Query.Select("experimental")

	return &CodegenExperimental{
		Query:  q,
		Client: r.Client,
	}
}
...
// CodegenIntrospectOpts contains options for Codegen.Introspect
type CodegenIntrospectOpts struct {
	//
...
func (r *Codegen) Introspect(opts ...CodegenIntrospectOpts) *CodegenSchema {
	q := r.Query.Select("introspect")
	for i := len(opts) - 1; i >= 0; i-- {
		// `fromJson` optional argument
		if !querybuilder.IsZeroValue(opts[i].FromJSON) {
			q = q.Arg("fromJson", opts[i].FromJSON)
		}
	}
...
func (r *Codegen) IntrospectionQuery(ctx context.Context) (string, error) {
	if r.introspectionQuery != nil {
		return *r.introspectionQuery, nil
	}
	q := r.Query.Select("introspectionQuery")
...
type CodegenEnumValue struct {
	...
	description       *string
	id                *CodegenEnumValueID
	isDeprecated      *bool
	name              *string
}

// The reason for deprecation, if exists
func (r *CodegenEnumValue) DeprecationReason(ctx context.Context) (string, error) {
...
func (r *CodegenEnumValue) Description(ctx context.Context) (string, error) {
...
// A unique identifier for this CodegenEnumValue.
func (r *CodegenEnumValue) ID(ctx context.Context) (CodegenEnumValueID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenEnumValueID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenEnumValue) XXX_GraphQLType() string {
	return "CodegenEnumValue"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenEnumValue) XXX_GraphQLIDType() string {
	return "CodegenEnumValueID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenEnumValue) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenEnumValue) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenEnumValue) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenEnumValueFromID(CodegenEnumValueID(id))
	return nil
}

// Is the enum value deprecated?
func (r *CodegenEnumValue) IsDeprecated(ctx context.Context) (bool, error) {
...
func (r *CodegenEnumValue) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
...
// Experimental alternative to the introspection query, using the TypeDef API
type CodegenExperimental struct {
	Query  *querybuilder.Selection
	Client graphql.Client

	id *CodegenExperimentalID
}

// A unique identifier for this CodegenExperimental.
func (r *CodegenExperimental) ID(ctx context.Context) (CodegenExperimentalID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenExperimentalID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenExperimental) XXX_GraphQLType() string {
	return "CodegenExperimental"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenExperimental) XXX_GraphQLIDType() string {
	return "CodegenExperimentalID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenExperimental) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenExperimental) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenExperimental) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenExperimentalFromID(CodegenExperimentalID(id))
	return nil
}
...
func (r *CodegenExperimental) InputNames(ctx context.Context) ([]string, error) {
	q := r.Query.Select("inputNames")
...
// every function call.
func (r *CodegenExperimental) ObjectNames(ctx context.Context) ([]string, error) {
	q := r.Query.Select("objectNames")
...
func (r *CodegenField) Args(ctx context.Context) ([]CodegenInputValue, error) {
	q := r.Query.Select("args")

	q = q.Select("id")

	type args struct {
		Id CodegenInputValueID
	}

	convert := func(fields []args) []CodegenInputValue {
		out := []CodegenInputValue{}

		for i := range fields {
			val := CodegenInputValue{id: &fields[i].Id}
			val.Query = querybuilder.Query().Select("loadCodegenInputValueFromID").Arg("id", fields[i].Id)
			val.Client = r.Client
			out = append(out, val)
		}
...
// The reason for deprecation, if exists
func (r *CodegenField) DeprecationReason(ctx context.Context) (string, error) {
	if r.deprecationReason != nil {
		return *r.deprecationReason, nil
	}
	q := r.Query.Select("deprecationReason")
...
func (r *CodegenField) Description(ctx context.Context) (string, error) {
	if r.description != nil {
		return *r.description, nil
	}
	q := r.Query.Select("description")
...
func (r *CodegenField) GetArg(name string) *CodegenInputValue {
	q := r.Query.Select("getArg")
	q = q.Arg("name", name)

	return &CodegenInputValue{
		Query:  q,
		Client: r.Client,
	}
}
...
func (r *CodegenField) HasOptionalArgs(ctx context.Context) (bool, error) {
	if r.hasOptionalArgs != nil {
		return *r.hasOptionalArgs, nil
	}
	q := r.Query.Select("hasOptionalArgs")
...
// A unique identifier for this CodegenField.
func (r *CodegenField) ID(ctx context.Context) (CodegenFieldID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenFieldID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenField) XXX_GraphQLType() string {
	return "CodegenField"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenField) XXX_GraphQLIDType() string {
	return "CodegenFieldID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenField) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenField) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenField) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenFieldFromID(CodegenFieldID(id))
	return nil
}

// Is the field deprecated?
func (r *CodegenField) IsDeprecated(ctx context.Context) (bool, error) {
	if r.isDeprecated != nil {
		return *r.isDeprecated, nil
	}
	q := r.Query.Select("isDeprecated")
...
func (r *CodegenField) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.Query.Select("name")
...
// inconsistency.
func (r *CodegenField) NameWords(ctx context.Context) (string, error) {
	if r.nameWords != nil {
		return *r.nameWords, nil
	}
	q := r.Query.Select("nameWords")
...
func (r *CodegenField) OptionalArgs(ctx context.Context) ([]CodegenInputValue, error) {
	q := r.Query.Select("optionalArgs")
	...
	convert := func(fields []optionalArgs) []CodegenInputValue {
		out := []CodegenInputValue{}
...
func (r *CodegenField) RequiredArgs(ctx context.Context) ([]CodegenInputValue, error) {
	q := r.Query.Select("requiredArgs")
	...
	convert := func(fields []requiredArgs) []CodegenInputValue {
		out := []CodegenInputValue{}
...
func (r *CodegenField) Type() *CodegenTypeRef {
	q := r.Query.Select("type")

	return &CodegenTypeRef{
		Query:  q,
		Client: r.Client,
	}
}
...
func (r *CodegenInputValue) DefaultValue(ctx context.Context) (string, error) {
...
func (r *CodegenInputValue) Description(ctx context.Context) (string, error) {
	if r.description != nil {
		return *r.description, nil
	}
	q := r.Query.Select("description")
...
// A unique identifier for this CodegenInputValue.
func (r *CodegenInputValue) ID(ctx context.Context) (CodegenInputValueID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenInputValueID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenInputValue) XXX_GraphQLType() string {
	return "CodegenInputValue"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenInputValue) XXX_GraphQLIDType() string {
	return "CodegenInputValueID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenInputValue) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenInputValue) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenInputValue) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenInputValueFromID(CodegenInputValueID(id))
	return nil
}

// The name of the input
func (r *CodegenInputValue) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.Query.Select("name")
...
// applying the language's naming conventions, which can be a source of
// inconsistency.
func (r *CodegenInputValue) NameWords(ctx context.Context) (string, error) {
	if r.nameWords != nil {
		return *r.nameWords, nil
	}
	q := r.Query.Select("nameWords")
...
func (r *CodegenInputValue) Type() *CodegenTypeRef {
	q := r.Query.Select("type")
...
func (r *CodegenSchema) AsJSON(ctx context.Context) (string, error) {
	if r.asJson != nil {
		return *r.asJson, nil
	}
...
func (r *CodegenSchema) Enums(ctx context.Context) ([]CodegenType, error) {
	...
	convert := func(fields []enums) []CodegenType {
		out := []CodegenType{}

		for i := range fields {
			val := CodegenType{id: &fields[i].Id}
			val.Query = querybuilder.Query().Select("loadCodegenTypeFromID").Arg("id", fields[i].Id)
			val.Client = r.Client
			out = append(out, val)
		}
...
// Get a type by name
func (r *CodegenSchema) GetType(name string) *CodegenType {
	q := r.Query.Select("getType")
	q = q.Arg("name", name)
...
// A unique identifier for this CodegenSchema.
func (r *CodegenSchema) ID(ctx context.Context) (CodegenSchemaID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenSchemaID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenSchema) XXX_GraphQLType() string {
	return "CodegenSchema"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenSchema) XXX_GraphQLIDType() string {
	return "CodegenSchemaID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenSchema) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenSchema) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenSchema) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenSchemaFromID(CodegenSchemaID(id))
	return nil
}

// Get a list of all input object types
func (r *CodegenSchema) Inputs(ctx context.Context) ([]CodegenType, error) {
	...
	convert := func(fields []inputs) []CodegenType {
		out := []CodegenType{}
...
func (r *CodegenSchema) Objects(ctx context.Context) ([]CodegenType, error) {
	...
	convert := func(fields []objects) []CodegenType {
		out := []CodegenType{}
...
func (r *CodegenSchema) RootType() *CodegenType {
	q := r.Query.Select("rootType")
...
func (r *CodegenSchema) Scalars(ctx context.Context) ([]CodegenType, error) {
	...
	convert := func(fields []scalars) []CodegenType {
		out := []CodegenType{}
...
func (r *CodegenSchema) Types(ctx context.Context) ([]CodegenType, error) {
	...
	convert := func(fields []types) []CodegenType {
		out := []CodegenType{}
...
func (r *CodegenType) Description(ctx context.Context) (string, error) {
	if r.description != nil {
		return *r.description, nil
	}
	q := r.Query.Select("description")
...
func (r *CodegenType) EnumValues(ctx context.Context) ([]CodegenEnumValue, error) {
	...
	convert := func(fields []enumValues) []CodegenEnumValue {
		out := []CodegenEnumValue{}

		for i := range fields {
			val := CodegenEnumValue{id: &fields[i].Id}
			val.Query = querybuilder.Query().Select("loadCodegenEnumValueFromID").Arg("id", fields[i].Id)
			val.Client = r.Client
			out = append(out, val)
		}
...
func (r *CodegenType) Fields(ctx context.Context) ([]CodegenField, error) {
	...
	convert := func(fields []fields) []CodegenField {
		out := []CodegenField{}

		for i := range fields {
			val := CodegenField{id: &fields[i].Id}
			val.Query = querybuilder.Query().Select("loadCodegenFieldFromID").Arg("id", fields[i].Id)
			val.Client = r.Client
			out = append(out, val)
		}
...
func (r *CodegenType) GetField(name string) *CodegenField {
	q := r.Query.Select("getField")
	q = q.Arg("name", name)
...
// A unique identifier for this CodegenType.
func (r *CodegenType) ID(ctx context.Context) (CodegenTypeID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenTypeID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenType) XXX_GraphQLType() string {
	return "CodegenType"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenType) XXX_GraphQLIDType() string {
	return "CodegenTypeID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenType) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenType) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenType) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenTypeFromID(CodegenTypeID(id))
	return nil
}

// An input object type's fields
func (r *CodegenType) InputFields(ctx context.Context) ([]CodegenInputValue, error) {
	...
	convert := func(fields []inputFields) []CodegenInputValue {
		out := []CodegenInputValue{}
...
// Is the type an enum?
func (r *CodegenType) IsEnum(ctx context.Context) (bool, error) {
	if r.isEnum != nil {
		return *r.isEnum, nil
	}
	q := r.Query.Select("isEnum")
...
func (r *CodegenType) IsInputObject(ctx context.Context) (bool, error) {
	if r.isInputObject != nil {
		return *r.isInputObject, nil
	}
	q := r.Query.Select("isInputObject")
...
func (r *CodegenType) IsObject(ctx context.Context) (bool, error) {
	if r.isObject != nil {
...
func (r *CodegenType) IsRoot(ctx context.Context) (bool, error) {
	if r.isRoot != nil {
		return *r.isRoot, nil
	}
	q := r.Query.Select("isRoot")
...
func (r *CodegenType) IsScalar(ctx context.Context) (bool, error) {
	if r.isScalar != nil {
		return *r.isScalar, nil
	}
	q := r.Query.Select("isScalar")
...
func (r *CodegenType) Kind(ctx context.Context) (string, error) {
	if r.kind != nil {
		return *r.kind, nil
	}
...
func (r *CodegenType) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.Query.Select("name")
...
type WithCodegenTypeRefFunc func(r *CodegenTypeRef) *CodegenTypeRef

// With calls the provided function with current CodegenTypeRef.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *CodegenTypeRef) With(f WithCodegenTypeRefFunc) *CodegenTypeRef {
	return f(r)
}

// A unique identifier for this CodegenTypeRef.
func (r *CodegenTypeRef) ID(ctx context.Context) (CodegenTypeRefID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.Query.Select("id")

	var response CodegenTypeRefID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *CodegenTypeRef) XXX_GraphQLType() string {
	return "CodegenTypeRef"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *CodegenTypeRef) XXX_GraphQLIDType() string {
	return "CodegenTypeRefID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *CodegenTypeRef) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *CodegenTypeRef) MarshalJSON() ([]byte, error) {
	id, err := r.ID(context.Background())
	if err != nil {
		return nil, err
	}
...
func (r *CodegenTypeRef) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadCodegenTypeRefFromID(CodegenTypeRefID(id))
	return nil
}
...
func (r *CodegenTypeRef) IsLeaf(ctx context.Context) (bool, error) {
	if r.isLeaf != nil {
		return *r.isLeaf, nil
	}
	q := r.Query.Select("isLeaf")
...
// Is it a list?
func (r *CodegenTypeRef) IsList(ctx context.Context) (bool, error) {
	if r.isList != nil {
		return *r.isList, nil
	}
...
func (r *CodegenTypeRef) IsObject(ctx context.Context) (bool, error) {
	if r.isObject != nil {
		return *r.isObject, nil
	}
	q := r.Query.Select("isObject")
...
//
// Only makes sense
func (r *CodegenTypeRef) IsOptional(ctx context.Context) (bool, error) {
	if r.isOptional != nil {
		return *r.isOptional, nil
	}
	q := r.Query.Select("isOptional")
...
func (r *CodegenTypeRef) Kind(ctx context.Context) (string, error) {
	if r.kind != nil {
		return *r.kind, nil
	}
	q := r.Query.Select("kind")
...
func (r *CodegenTypeRef) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.Query.Select("name")
...
func (r *CodegenTypeRef) OfType() *CodegenTypeRef {
...
func (r *Client) LoadCodegenEnumValueFromID(id CodegenEnumValueID) *CodegenEnumValue {
	q := r.Query.Select("loadCodegenEnumValueFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadCodegenExperimentalFromID(id CodegenExperimentalID) *CodegenExperimental {
	q := r.Query.Select("loadCodegenExperimentalFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadCodegenFieldFromID(id CodegenFieldID) *CodegenField {
	q := r.Query.Select("loadCodegenFieldFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadCodegenInputValueFromID(id CodegenInputValueID) *CodegenInputValue {
	q := r.Query.Select("loadCodegenInputValueFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadCodegenSchemaFromID(id CodegenSchemaID) *CodegenSchema {
	q := r.Query.Select("loadCodegenSchemaFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadCodegenTypeFromID(id CodegenTypeID) *CodegenType {
	q := r.Query.Select("loadCodegenTypeFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadCodegenTypeRefFromID(id CodegenTypeRefID) *CodegenTypeRef {
	q := r.Query.Select("loadCodegenTypeRefFromID")
	q = q.Arg("id", id)
